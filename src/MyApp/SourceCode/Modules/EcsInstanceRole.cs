...
{
    public sealed class EcsInstanceRole: Construct
    {
        Construct scope = null;
        string id = "";

        public Role Role {get;set;}
        public EcsInstanceRole(Construct scope, string id): base(scope, id)
        {
           this.scope = scope;
           this.id = id;
            ...
            this.Role =  GetRole(
                this, id+"-role",
                Utilities.ServiceBuilder.GetEcsInstanceRoleManagedPolicyARNs(),
                new string[]{
                    Constants.EC2_INSTANCE_ROLE_SERVICE,
                    Constants.ECS_INSTANCE_ROLE_SERVICE
                }, 
                Constants.ECS_INSTANCE_ROLE_NAME
            );
        }
